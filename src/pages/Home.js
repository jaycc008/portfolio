...
const Wrapper = styled.div`
	...
	@media (${Styles.breakpoints.laptopHeight}),
		(${Styles.breakpoints.laptopWidth}) {
		padding-left: 2rem;
	}
`
...
const Underline = styled.span`
	z-index: 1;
	box-shadow: inset 0 -0.9rem 0 ${Styles.colors.primary},
		inset 0 -3.9rem 0 ${Styles.colors.highlight};

	@media (${Styles.breakpoints.laptopHeight}),
		(${Styles.breakpoints.laptopWidth}) {
		box-shadow: inset 0 -0.9rem 0 ${Styles.colors.primary},
			inset 0 -3.7rem 0 ${Styles.colors.highlight};
	}

	@media (${Styles.breakpoints.tabletWidth}) {
		box-shadow: inset 0 -0.9rem 0 ${Styles.colors.primary},
			inset 0 -3.1rem 0 ${Styles.colors.highlight};
	}

	@media (${Styles.breakpoints.mobileWidth}) {
		box-shadow: inset 0 -0.9rem 0 ${Styles.colors.primary},
			inset 0 -2.3rem 0 ${Styles.colors.highlight};
	}
`
